...
//**************************************************************************//
// We aren't using DirectX9, so I have disabled this unit.  Perhaps			//
// somebody can work out how to extracate this unit form the whole project  //
// - Nigel																	//
//**************************************************************************//
...
HRESULT CALLBACK OnD3D9CreateDevice( IDirect3DDevice9* pd3dDevice, const D3DSURFACE_DESC* pBackBufferSurfaceDesc,
                                     void* pUserContext )
{
	ShowMessage(L"We aren't using DirectX9; sorry");
    HRESULT hr;
