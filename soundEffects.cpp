...
soundEffects::soundEffects(SoundManager *manager)
{
	soundDurationInSeconds = 2;
	samplingRate		   = 44100;
	numAudioChannels       = 2;
...
HRESULT soundEffects::createSoundFromFile(WCHAR *fileName, int durationInSeconds, 
									  bool streaming)
{
	HRESULT hr;
...
HRESULT soundEffects::play()
{
	timeStarted = timeGetTime();
	return pXACTWave->Play();
}

HRESULT soundEffects::stop(DWORD flags)
{
...
void soundEffects::updateStatus()
{
	//**********************************************************************//
...
HRESULT soundEffects::resetSound()
{
	HRESULT hr;
...
HRESULT soundEffects::LoadWaveFileInMemory( IXACT3Engine* pXACTEngine, WCHAR* strFile, DWORD dwSeconds,
...
HRESULT soundEffects::LoadWaveFileStreaming( IXACT3Engine* pXACTEngine, WCHAR* strFile, DWORD dwSeconds,
                               DWORD dwSampleRate, DWORD dwChannels, DWORD dwBits,
